...
class RatingsController extends AppController
{
    ...
    public function add()
    {
        ...
        $fromUsers = $this->Ratings->Users->find('list', ['limit' => 200]);
        $toUsers = $this->Ratings->Users->find('list', ['limit' => 200]);
        $biditems = $this->Ratings->Biditems->find('list', ['limit' => 200]);
        $this->set(compact('rating', 'fromUsers', 'toUsers', 'biditems'));
    }
