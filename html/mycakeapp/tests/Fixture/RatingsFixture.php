...
class RatingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'from_user_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'to_user_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'updated_at' => '2020-07-10 02:31:54',
                'updated' => '2020-07-10 02:31:54',
                'created_at' => '2020-07-10 02:31:54',
                'created' => '2020-07-10 02:31:54',
            ],
        ];
        parent::init();
    }
