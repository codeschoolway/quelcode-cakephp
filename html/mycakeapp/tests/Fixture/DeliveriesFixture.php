...
class DeliveriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'phone' => ['type' => 'string', 'length' => 13, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'is_shipped' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'is_received' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_shipped' => 1,
                'is_received' => 1,
                'updated' => '2020-07-11 01:15:19',
                'created' => '2020-07-11 01:15:19',
            ],
        ];
        parent::init();
    }
